...
setmetatable(AF_Strings["de"], {__index = AF_Strings["en"]})
setmetatable(AF_Strings["es"], {__index = AF_Strings["en"]})
setmetatable(AF_Strings["fr"], {__index = AF_Strings["en"]})
setmetatable(AF_Strings["ru"], {__index = AF_Strings["en"]})
